...
{   
    ...
    [HttpPost]
    public ActionResult Cadastrar(CadastrarFabricanteViewModel viewModel)
    {
    ...
    [HttpPost]
    public ActionResult Editar(EditarFabricanteViewModel viewModel)
    {   
        ...
        repositorioFabricante.Editar(viewModel.Id, fabricanteAtualizado);
